...
@Component({
  selector: 'app-tablefiltered-user',
  templateUrl: './tablefiltered-user.component.html',
  styleUrls: ['./tablefiltered-user.component.css']
})
export class TablefilteredUserComponent implements OnInit {
